...
const DiscoveryPageContent: React.FC = () => {
  ...
  )), [recommendationsLoading, viewMode, getRecommendations, handleContentInteraction, recommendations.length]);
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div>
              ...
              <p className="text-gray-600">Encuentra contenido que te encantará</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          <Tabs tabs={tabElements} activeTab={activeTab} onTabChange={setActiveTab} />
        </div>
